...
const BookingFormId = () => {
  ...
  const onSubmit = (data) => {
    ...
    axios
      .post(
        "https://bhromonpoth-travels-server-production.up.railway.app/bookinglist",
        data
      )
      .then((res) => {
  ...
  return (
    <div>
      ...
      />
      <section
        className="relative text-white bg-center xl:py-20 lg:py-24 bg-no-repeat bg-cover"
        role="banner"
        style={{
          backgroundImage: "url(https://wallpapercave.com/wp/wp4069431.jpg)",
        }}
      >
              ...
              <div className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 flex flex-col ">
                ...
                <div className="-mx-3 md:flex mb-2">
                  <div className="md:w-1/2 px-3 mb-6 md:mb-0">
                    ...
                    <div>
                      <select
                        className="w-full bg-green-200 border border-green-500 text-black text-xs py-3 px-4 pr-8 mb-3 rounded"
                        id="tfrom"
                        {...register("travelingfrom")}
                      >
                ...
                <div className="-mx-3 md:flex mb-6">
                  <div className="md:w-1/3 px-3 mb-6 md:mb-0 flex">
                    <label className="inline-flex items-center mt-3">
                      <input
                        ...
                        {...register("bookhotel")}
                      />
                      <span className="ml-2 text-black">Book hotel?</span>
                    </label>
                  </div>
                  <div className="md:w-1/3 px-3 mb-6 md:mb-0 flex">
                    <label className="inline-flex items-center mt-3">
                  ...
                  <div className="md:w-1/3 px-3 mb-6 md:mb-0 flex">
                    <label className="inline-flex items-center mt-3">
                      ...
                      />
                      <span className="ml-2 text-black">Return ticket?</span>
                    </label>
                  </div>
                </div>
                {/* BUTTON */}
                ...
                <p className="text-black">
                  After confirming booking our support will contact with you
                </p>
