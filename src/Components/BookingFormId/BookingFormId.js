                            ...
                            <div className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 flex flex-col ">
                                <div className="-mx-3 md:flex mb-6">
                                    <div className="md:w-1/2 px-3 mb-6 md:mb-0">
                                        ...
                                        <input className="w-full bg-green-200 text-black border border-green-500 rounded py-3 px-4 mb-3" id="name" defaultValue={displayName} readOnly type="text" placeholder="Your name" {...register("name", { required: true })} />
                                    ...
                                    <div className="md:w-1/2 px-3">
                                        ...
                                        <input className="w-full bg-green-200 text-black border border-green-500 rounded py-3 px-4 mb-3" id="email" defaultValue={email} readOnly type="text" placeholder="Your email" {...register("email", { required: true })} />
                                    </div>
                                </div>
                                {/* SECOND ROW */}
                                <div className="-mx-3 md:flex mb-6">
