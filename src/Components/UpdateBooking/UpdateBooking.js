...
const UpdateBooking = () => {
  ...
  useEffect(() => {
    const url = `https://bhromonpoth-travels-server-production.up.railway.app/bookinglist/${id}`;
    fetch(url)
      .then((res) => res.json())
              ...
              <div className="md:w-1/2 px-3 mb-6 md:mb-0">
                ...
                <div>
                  <select
                    ...
                    id="tfrom"
                    onChange={tfromupdate}
                    value={item.travelingfrom || ""}
                  >
