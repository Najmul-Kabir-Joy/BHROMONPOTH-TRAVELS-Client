...
const PackageDetails = () => {
  ...
  const url = `https://bhromonpoth-travels-server-production.up.railway.app/packagelist/${id.id}`;
  useEffect(() => {
    fetch(url)
      .then((res) => res.json())
  ...
  return (
    <div>
      <div className="mt-10">
        <h1 className="text-3xl inline border-b-2 border-green-400 uppercase">
          DETAILS FOR {details.countryname}
        </h1>
      </div>
            ...
            <div className="flex flex-wrap -m-4">
              <div className="xl:w-1/2 md:w-1/2 p-4 shadow-xl mb-5 border border-green-200">
                <div className=" p-6 rounded-lg">
                  ...
                  <h2 className="text-lg text-gray-900 font-medium title-font mb-2">
                    ${details.money}/person
                  </h2>
                  <p className="leading-relaxed text-base">
                    For each person the total amount is {details.money}$ only
                  </p>
                </div>
              </div>
              <div className="xl:w-1/2 md:w-1/2 p-4 shadow-xl mb-5 border border-green-200">
                <div className=" p-6 rounded-lg">
                  ...
                  <p className="leading-relaxed text-base">
                    We will spend total {details.days} including departure day.
                  </p>
                </div>
              </div>
              <div className="xl:w-1/2 md:w-1/2 p-4 shadow-xl mb-5 border border-green-200">
                <div className="p-6 rounded-lg">
                  ...
                  <h2 className="text-lg text-green-900 font-medium title-font mb-2">
                    {details.persons} persons
                  </h2>
                  <p className="leading-relaxed text-base">
                    Our maximum group member limit is only {details.persons}{" "}
                    persons.
                  </p>
                </div>
              </div>
              <div className="xl:w-1/2 md:w-1/2 p-4 shadow-xl mb-5 border border-green-200">
                <div className="p-6 rounded-lg">
                  ...
                  <p className="leading-relaxed text-base">
                    We will visit {details.places} awesome tourist attraction
                    places.
                  </p>
                </div>
              </div>
              <div className="xl:w-1/2 md:w-1/2 p-4 shadow-xl mb-5 border border-green-200">
                <div className=" p-6 rounded-lg">
                  ...
                  <p className="leading-relaxed text-base">
                    We will enjoy one night cruise party in a big cruise ship.
                  </p>
                </div>
              </div>
              <div className="xl:w-1/2 md:w-1/2 p-4 shadow-xl mb-5 border border-green-200">
                <div className="p-6 rounded-lg">
                  ...
                  <p className="leading-relaxed text-base">
                    Each participant will get a "BhromonPoth" branded tshirt.
                  </p>
                </div>
              </div>
            </div>
